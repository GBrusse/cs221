 ...
 * Iterator Tests for Change Scenario 19: [A, B] -> addAfter(C, A) -> [A, C, B]
 *
 * @author Matt T
 *
 */	
public class ItrTest_19_AB_addAfterCA_ACB
{
	...
	private static final Character MIDDLE = IteratorTests.C;
	...
	public void initialize()
	{
		...
		// apply change
		list.addAfter(IteratorTests.C, IteratorTests.A);
