 ...
 * Iterator Tests for Change Scenario 40: [A, B, C] -> remove(2) -> [A, B]
 *
 * @author Matt T
 *
 */
public class ItrTest_40_ABC_remove2_AB
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_40_ABC_remove2_AB"; 
