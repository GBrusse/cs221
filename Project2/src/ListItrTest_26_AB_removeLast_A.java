 ...
 * ListIterator Tests for Change Scenario 26: [A, B] -> removeLast() -> [A]
 *
 * @author Matt T
 *
 */

public class ListItrTest_26_AB_removeLast_A
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_26_AB_removeLast_A"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 26: [A, B] -> removeLast() -> [A]"; 
	// Number of tests run 
