 ...
 * Iterator Tests for Change Scenario 37: [A, B, C] -> remove(C) -> [A, B]
 *
 * @author Matt T
 *
 */
public class ItrTest_37_ABC_removeC_AB
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_37_ABC_removeC_AB"; 
