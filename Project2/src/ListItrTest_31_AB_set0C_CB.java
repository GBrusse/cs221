 ...
 * ListIterator Tests for Change Scenario 31: [A, B] -> set(0, C) -> [C, B]
 *
 * @author Matt T
 *
 */

public class ListItrTest_31_AB_set0C_CB
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_31_AB_set0C_CB"; 
	...
	public void initialize()
	{
		...
		// apply change
		list.set(0, ListIteratorTests.C); 
