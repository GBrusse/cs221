 ...
 * Iterator Tests for Change Scenario 33: [A, B, C] -> removeFirst() -> [B, C]
 *
 * @author Matt T
 *
 */
public class ItrTest_33_ABC_removeFirst_BC
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_33_ABC_removeFirst_BC"; 
