 ...
 * Iterator Tests for Change Scenario 2: empty list -> addToFront(A) -> [A]
 *
 * @author Matt T
 *
 */
public class ItrTest_2_emptyList_addToFrontA_A
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_2_emptyList_addToFrontA_A"; 
	...
	public void initialize()
	{
		...
		// apply change 
		list.addToFront(IteratorTests.A); 
