 ...
 * Iterator Tests for Change Scenario 4: empty list -> add(A) -> [A]
 *
 * @author Matt T
 *
 */
public class ItrTest_4_emptyList_addA_A
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_4_emptyList_addA_A"; 
