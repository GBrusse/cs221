 ...
 * ListIterator Tests for Change Scenario 6: [A] -> addToFront(B) -> [B, A]
 *
 * @author Matt T
 *
 */

public class ListItrTest_6_A_addToFrontB_BA
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_6_A_addToFrontB_BA"; 
	...
	private static final Character LAST = ListIteratorTests.A; 
	...
	public void initialize()
	{
		...
		// apply change
		list.addToFront(ListIteratorTests.B); 
