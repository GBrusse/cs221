 ...
 * ListIterator Tests for Change Scenario 4: empty list -> add(A) -> [A]
 *
 * @author Matt T
 *
 */

public class ListItrTest_4_emptyList_addA_A
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_4_emptyList_addA_A"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 4: empty list -> add(A) -> [A]"; 
	// Number of tests run 
