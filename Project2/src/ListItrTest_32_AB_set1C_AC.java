 ...
 * ListIterator Tests for Change Scenario 32: [A, B] -> set(1, C) -> [A, C]
 *
 * @author Matt T
 *
 */

public class ListItrTest_32_AB_set1C_AC
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_32_AB_set1C_AC"; 
	...
	public void initialize()
	{
		...
		// apply change
		list.set(1, ListIteratorTests.C); 
