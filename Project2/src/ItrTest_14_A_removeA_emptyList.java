 ...
 * Iterator Tests for Change Scenario 14: [A] -> remove(A) -> [ ]
 *
 * @author Matt T
 *
 */
public class ItrTest_14_A_removeA_emptyList
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_14_A_removeA_emptyList"; 
