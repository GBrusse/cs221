...
*  ListIterator Tests for Change Scenario 30: [A, B] -> remove(1) -> [A]
 *
 * @author Matt T
 *
 */

public class ListItrTest_30_AB_remove1_A
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_30_AB_remove1_A"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 30: [A, B] -> remove(1) -> [A]"; 
	// Number of tests run 
