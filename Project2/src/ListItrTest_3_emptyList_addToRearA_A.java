 ...
 * ListIterator Tests for Change Scenario 3: empty list -> addToRear(A) -> [A]
 *
 * @author Matt T
 *
 */

public class ListItrTest_3_emptyList_addToRearA_A
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_3_emptyList_addToRearA_A"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 3: empty list -> addToRear(A) -> [A]"; 
	// Number of tests run 
	...
	public void initialize()
	{
		...
		// apply change
		list.addToRear(ListIteratorTests.A);
