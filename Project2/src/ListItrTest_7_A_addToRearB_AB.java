 ...
 * ListIterator Tests for Change Scenario 7: [A] -> addToRear(B) -> [A, B]
 *
 * @author Matt T
 *
 */

public class ListItrTest_7_A_addToRearB_AB
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_7_A_addToRearB_AB"; 
	...
	public void initialize()
	{
		...
		// apply change
		list.addToRear(ListIteratorTests.B);
