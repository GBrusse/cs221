 ...
 * Iterator Tests for Change Scenario 27: [A, B] -> remove(A) -> [B]
 *
 * @author Matt T
 *
 */
public class ItrTest_27_AB_removeA_B
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_27_AB_removeA_B"; 
