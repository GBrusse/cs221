 ...
 * ListIterator Tests for Change Scenario 29: [A, B] -> remove(0) -> [B]
 *
 * @author Matt T
 *
 */

public class ListItrTest_29_AB_remove0_B
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_29_AB_remove0_B"; 
