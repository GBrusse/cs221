 ...
 * ListIterator Tests for Change Scenario 15: [A] -> remove(0) -> [ ]
 *
 * @author Matt T
 *
 */

public class ListItrTest_15_A_remove0_emptyList
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_15_A_remove0_emptyList"; 
