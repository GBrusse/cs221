 ...
 * ListIterator Tests for Change Scenario 17: [A, B] -> addToFront(C) -> [C, A, B]
 *
 * @author Matt T
 *
 */

public class ListItrTest_17_AB_addToFrontC_CAB
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_17_AB_addToFrontC_CAB"; 
	...
	// Elements in list 
	private static final Character FIRST = ListIteratorTests.C;
	private static final Character MIDDLE = ListIteratorTests.A; 
	...
	public void initialize()
	{
		...
		// apply change
		list.addToFront(ListIteratorTests.C); 
