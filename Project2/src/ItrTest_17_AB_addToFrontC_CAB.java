 ...
 * Iterator Tests for Change Scenario 17: [A, B] -> addToFront(C) -> [C, A, B]
 *
 * @author Matt T
 *
 */		
public class ItrTest_17_AB_addToFrontC_CAB
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_17_AB_addToFrontC_CAB"; 
	...
	private static final Character FIRST = IteratorTests.C;
	private static final Character MIDDLE = IteratorTests.A;
	...
	public void initialize()
	{
		...
		// apply change
		list.addToFront(IteratorTests.C); 
