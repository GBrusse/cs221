 ...
 * Testing for IndexedUnsortedList interface implementation: 
  * ListIterator Tests for Change Scenario 10: [A] -> add(0, B) -> [B, A]
 *
 * @author Matt T
 *
 */

public class ListItrTest_10__A_add0B_BA
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_10__A_add0B_BA"; 
	...
	public void initialize()
	{
		...
		// apply change
		list.add(0, ListIteratorTests.B);
