 ...
 * Iterator Tests for Change Scenario 38: [A, B, C] -> remove(0) -> [B, C]
 *
 * @author Matt T
 *
 */
public class ItrTest_38_ABC_remove0_BC
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_38_ABC_remove0_BC"; 
