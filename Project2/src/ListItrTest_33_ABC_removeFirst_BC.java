 ...
 * ListIterator Tests for Change Scenario 33: [A, B, C] -> removeFirst() -> [B, C]
 *
 * @author Matt T
 *
 */

public class ListItrTest_33_ABC_removeFirst_BC
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_33_ABC_removeFirst_BC"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 33: [A, B, C] -> removeFirst() -> [B, C]"; 
	// Number of tests run 
