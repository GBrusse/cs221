 ...
 * ListIterator Tests for Change Scenario 37: [A, B, C] -> remove(C) -> [A, B]
 *
 * @author Matt T
 *
 */

public class ListItrTest_37_ABC_removeC_AB
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_37_ABC_removeC_AB"; 
	...
	public void initialize()
	{
		...
		// apply change
		list.remove(ListIteratorTests.C); 
