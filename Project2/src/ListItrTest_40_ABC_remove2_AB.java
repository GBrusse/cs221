 ...
 * ListIterator Tests for Change Scenario 40: [A, B, C] -> remove(2) -> [A, B]
 *
 * @author Matt T
 *
 */

public class ListItrTest_40_ABC_remove2_AB
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_40_ABC_remove2_AB"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 40: [A, B, C] -> remove(2) -> [A, B]"; 
	// Number of tests run 
