 ...
 * Iterator Tests for Change Scenario 34: [A, B, C] -> removeLast() -> [A, B]
 *
 * @author Matt T
 *
 */
public class ItrTest_34_ABC_removeLast_AB
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_34_ABC_removeLast_AB"; 
