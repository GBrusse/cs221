 ...
 * ListIterator Tests for Change Scenario 12: [A] -> removeFirst() -> [ ]
 *
 * @author Matt T
 *
 */

public class ListItrTest_12_A_removeFirst_emptyList
{
	// List running tests on
	IndexedUnsortedList<Character> list;
	// ListIterator list to run tests 
	private ListIterator<Character> listItr; 
		

	//****** Constants used in tests *****************
	// Name of class
	private static String CLASS_NAME = "ListItrTest_12_A_removeFirst_emptyList"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 12: [A] -> removeFirst() -> [ ]"; 
	// Number of tests run 
	private static final int NUM_TESTS = 18; 
	// Type of list using in tests
	private ListType listType; 
	// State of ListIterator 
	...
	/**
	 * Sets up ListIterator for testing. 
	 */
