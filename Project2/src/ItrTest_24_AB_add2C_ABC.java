 ...
 * Iterator Tests for Change Scenario 24: [A, B] -> add (2, C) -> [A, B, C]
 *
 * @author Matt T
 *
 */
public class ItrTest_24_AB_add2C_ABC
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_24_AB_add2C_ABC"; 
