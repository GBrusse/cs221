 ...
 * ListIterator Tests for Change Scenario 19: [A, B] -> addAfter(C, A) -> [A, C, B]
 *
 * @author Matt T
 *
 */

public class ListItrTest_19_AB_addAfterCA_ACB
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_19_AB_addAfterCA_ACB"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 19: [A, B] -> addAfter(C, A) -> [A, C, B]"; 
	// Number of tests run 
	private static final int NUM_TESTS = 153;    
	...
	// Elements in list 
	private static final Character FIRST = ListIteratorTests.A;
	private static final Character MIDDLE = ListIteratorTests.C; 
	private static final Character LAST = ListIteratorTests.B; 
	...
	public void initialize()
	{
		...
		// apply change
		list.addAfter(ListIteratorTests.C, ListIteratorTests.A);
	...
	public void run(ListType listType)
	{
		...
		try 
		{
			...
			// next Test
			initialize(); 
			result = ListIteratorTests.next(listItr, MIDDLE, Result.MatchingValue); 
			RunListIteratorTests.printResults("next()", result);
			...
			//********* ListIterator State: initial position, next, next, next, then previous 
			System.out.println("ListIterator State: initial position, next, next, next, then previous");
			// ListIterator state
			listItrState = ListItrState.nextNextNextPrev;
			// value of nextIndex / previousIndex
			nextIndex = 2;
			previousIndex = 1; 
			...
			// previous Test
			initialize(); 
			result = ListIteratorTests.previous(listItr, MIDDLE, Result.MatchingValue); 
			RunListIteratorTests.printResults("previous()", result);
			...
			//********* ListIterator State: initial position, next, next, next, previous, then add 
			System.out.println("ListIterator State: initial position, next, next, next, previous, then add");
			// ListIterator state
			listItrState = ListItrState.nextNextNextPrevAdd;
			// value of nextIndex / previousIndex
			nextIndex = 3;
			previousIndex = 2; 
			...
			//********* ListIterator State: initial position, next, next, next, previous, then remove 
			System.out.println("ListIterator State: initial position, next, next, next, previous, then remove");
			// ListIterator state
			listItrState = ListItrState.nextNextNextPrevRemove;
			// value of nextIndex / previousIndex
			nextIndex = 2;
			previousIndex = 1; 
			...
			//********* ListIterator State: initial position, next, next, next, then add 
			System.out.println("ListIterator State: initial position, next, next, next, then add");
			// ListIterator state
			listItrState = ListItrState.nextNextNextAdd;
			// value of nextIndex / previousIndex
			nextIndex = 4;
			previousIndex = 3; 
