 ...
 * Iterator Tests for Change Scenario 35: [A, B, C] -> remove(A) -> [B, C]
 *
 * @author Matt T
 *
 */
public class ItrTest_35_ABC_removeA_BC
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_35_ABC_removeA_BC"; 
