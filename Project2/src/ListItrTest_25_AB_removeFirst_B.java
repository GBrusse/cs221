 ...
 * ListIterator Tests for Change Scenario 25: [A, B] -> removeFirst() -> [B]
 *
 * @author Matt T
 *
 */

public class ListItrTest_25_AB_removeFirst_B
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_25_AB_removeFirst_B"; 
