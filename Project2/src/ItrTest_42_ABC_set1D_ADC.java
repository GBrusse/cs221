 ...
 * Iterator Tests for Change Scenario 42: [A, B, C] -> set(1, D) -> [A, D, C]
 *
 * @author Matt T
 *
 */	
public class ItrTest_42_ABC_set1D_ADC
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_42_ABC_set1D_ADC"; 
	...
	private static final Character MIDDLE = IteratorTests.D;
