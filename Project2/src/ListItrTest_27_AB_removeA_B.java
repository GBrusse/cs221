 ...
 * ListIterator Tests for Change Scenario 27: [A, B] -> remove(A) -> [B]
 *
 * @author Matt T
 *
 */

public class ListItrTest_27_AB_removeA_B
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_27_AB_removeA_B"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 27: [A, B] -> remove(A) -> [B]"; 
	// Number of tests run 
