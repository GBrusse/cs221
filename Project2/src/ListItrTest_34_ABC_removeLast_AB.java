 ...
 * ListIterator Tests for Change Scenario 34: [A, B, C] -> removeLast() -> [A, B]
 *
 * @author Matt T
 *
 */

public class ListItrTest_34_ABC_removeLast_AB
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_34_ABC_removeLast_AB"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 34: [A, B, C] -> removeLast() -> [A, B]"; 
	// Number of tests run 
