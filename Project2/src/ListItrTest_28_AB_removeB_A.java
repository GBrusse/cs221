 ...
 * ListIterator Tests for Change Scenario 28: [A, B] -> remove(B) -> [A]
 *
 * @author Matt T
 *
 */

public class ListItrTest_28_AB_removeB_A
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_28_AB_removeB_A"; 
	...
	public void initialize()
	{
		...
		// apply change
		list.remove(ListIteratorTests.B); 
