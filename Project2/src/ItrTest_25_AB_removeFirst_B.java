 ...
 * Iterator Tests for Change Scenario 25: [A, B] -> removeFirst() -> [B]
 *
 * @author Matt T
 *
 */
public class ItrTest_25_AB_removeFirst_B
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_25_AB_removeFirst_B"; 
