 ...
 * ListIterator Tests for Change Scenario 36: [A, B, C] -> remove(B) -> [A, C]
 *
 * @author Matt T
 *
 */

public class ListItrTest_36_ABC_removeB_AC
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_36_ABC_removeB_AC"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 36: [A, B, C] -> remove(B) -> [A, C]"; 
	// Number of tests run 
