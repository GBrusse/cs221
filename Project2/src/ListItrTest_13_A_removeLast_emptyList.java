 ...
 * ListIterator Tests for Change Scenario 13: [A] -> removeLast() -> [ ]
 *
 * @author Matt T
 *
 */

public class ListItrTest_13_A_removeLast_emptyList
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_13_A_removeLast_emptyList"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 13: [A] -> removeLast() -> [ ]"; 
	// Number of tests run 
