 ...
 * ListIterator Tests for Change Scenario 2: empty list -> addToFront(A) -> [A]
 *
 * @author Matt T
 *
 */

public class ListItrTest_2_emptyList_addToFrontA_A
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_2_emptyList_addToFrontA_A"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 2: empty list -> addToFront(A) -> [A]"; 
	// Number of tests run 
	private static final int NUM_TESTS = 54;    
	...
	// Element in list 
	private static final Character VALID_ELEMENT = ListIteratorTests.A; 
	...
	public void initialize()
	{
		...
		// apply change 
		list.addToFront(ListIteratorTests.A); 
	...
	public void run(ListType listType)
	{
		...
		try 
		{
			...
			// next Test
			initialize(); 
			result = ListIteratorTests.next(listItr, VALID_ELEMENT, Result.MatchingValue); 
