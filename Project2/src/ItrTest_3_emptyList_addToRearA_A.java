 ...
 * Iterator Tests for Change Scenario 3: empty list -> addToRear(A) -> [A]
 *
 * @author Matt T
 *
 */
public class ItrTest_3_emptyList_addToRearA_A
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_3_emptyList_addToRearA_A"; 
	...
	public void initialize()
	{
		...
		// apply change
		list.addToRear(IteratorTests.A);
