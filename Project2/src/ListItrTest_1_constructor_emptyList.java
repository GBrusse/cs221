 ...
 * ListListIterator Tests for Change Scenario 1: no list -> constructor -> empty list
 *
 * @author Matt T
 *
 */

public class ListItrTest_1_constructor_emptyList
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_1_constructor_emptyList"; 
