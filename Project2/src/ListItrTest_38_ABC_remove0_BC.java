 ...
 * ListIterator Tests for Change Scenario 38: [A, B, C] -> remove(0) -> [B, C]
 *
 * @author Matt T
 *
 */

public class ListItrTest_38_ABC_remove0_BC
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_38_ABC_remove0_BC"; 
