 ...
 * ListIterator Tests for Change Scenario 21: [A, B] -> add(C) -> [A, B, C]
 *
 * @author Matt T
 *
 */

public class ListItrTest_21_AB_addC_ABC
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_21_AB_addC_ABC"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 21: [A, B] -> add(C) -> [A, B, C]"; 
	// Number of tests run 
