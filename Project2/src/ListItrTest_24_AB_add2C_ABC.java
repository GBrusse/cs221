 ...
 * ListIterator Tests for Change Scenario 24: [A, B] -> add (2, C) -> [A, B, C]
 *
 * @author Matt T
 *
 */

public class ListItrTest_24_AB_add2C_ABC
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_24_AB_add2C_ABC"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 24: [A, B] -> add (2, C) -> [A, B, C]"; 
	// Number of tests run 
	...
	public void initialize()
	{
		...
		// apply change
		list.add(2, ListIteratorTests.C);
