 ...
 * Iterator Tests for Change Scenario 26: [A, B] -> removeLast() -> [A]
 *
 * @author Matt T
 *
 */
public class ItrTest_26_AB_removeLast_A
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_26_AB_removeLast_A"; 
