 ...
 * Iterator Tests for Change Scenario 32: [A, B] -> set(1, C) -> [A, C]
 *
 * @author Matt T
 *
 */
public class ItrTest_32_AB_set1C_AC
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_32_AB_set1C_AC"; 
