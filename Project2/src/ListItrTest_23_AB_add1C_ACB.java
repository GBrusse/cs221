 ...
 * ListIterator Tests for Change Scenario 23: [A, B] -> add(1, C) -> [A, C, B]
 *
 * @author Matt T
 *
 */

public class ListItrTest_23_AB_add1C_ACB
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_23_AB_add1C_ACB"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 23: [A, B] -> add(1, C) -> [A, C, B]"; 
	// Number of tests run 
	...
	public void initialize()
	{
		...
		// apply change
		list.add(1, ListIteratorTests.C);
