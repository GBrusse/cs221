 ...
 * ListIterator Tests for Change Scenario 39: [A, B, C] -> remove(1) -> [A, C]
 *
 * @author Matt T
 *
 */

public class ListItrTest_39_ABC_remove1_AC
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_39_ABC_remove1_AC"; 
