 ...
 * Iterator Tests for Change Scenario 31: [A, B] -> set(0, C) -> [C, B]
 *
 * @author Matt T
 *
 */
public class ItrTest_31_AB_set0C_CB
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_31_AB_set0C_CB"; 
