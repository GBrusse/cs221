 ...
 * ListIterator Tests for Change Scenario 18: [A, B] -> addToRear(C) -> [A, B, C]
 *
 * @author Matt T
 *
 */

public class ListItrTest_18_AB_addToRearC_ABC
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_18_AB_addToRearC_ABC"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 18: [A, B] -> addToRear(C) -> [A, B, C]"; 
	// Number of tests run 
	...
	public void initialize()
	{
		...
		// apply change
		list.addToRear(ListIteratorTests.C); 
