 ...
 * ListIterator Tests for Change Scenario 11: [A] -> add(1, B) -> [A, B]
 *
 * @author Matt T
 *
 */

public class ListItrTest_11_A_add1B_AB
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_11_A_add1B_AB"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 11: [A] -> add(1, B) -> [A, B]"; 
	// Number of tests run 
	...
	public void initialize()
	{
		...
		// apply change
		list.add(1, ListIteratorTests.B);
