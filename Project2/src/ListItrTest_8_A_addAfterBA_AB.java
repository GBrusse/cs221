 ...
 * ListIterator Tests for Change Scenario 8: [A] -> addAfter(B, A) -> [A, B]
 *
 * @author Matt T
 *
 */

public class ListItrTest_8_A_addAfterBA_AB
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_8_A_addAfterBA_AB"; 
	...
	public void initialize()
	{
		...
		// apply change
		list.addAfter(ListIteratorTests.B, ListIteratorTests.A); 
