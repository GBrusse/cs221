 ...
 * Iterator Tests for Change Scenario 11: [A] -> add(1, B) -> [A, B]
 *
 * @author Matt T
 *
 */
public class ItrTest_11_A_add1B_AB
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_11_A_add1B_AB"; 
