 ...
 * ListIterator Tests for Change Scenario 5: empty list -> add(0, A) -> [A]
 *
 * @author Matt T
 *
 */

public class ListItrTest_5_emptyList_add0A_A
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_5_emptyList_add0A_A"; 
	...
	public void initialize()
	{
		...
		// apply change
		list.add(0, ListIteratorTests.A); 
