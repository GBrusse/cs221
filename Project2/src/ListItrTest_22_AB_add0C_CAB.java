 ...
 * ListIterator Tests for Change Scenario 22: [A, B] -> add(0, C) -> [C, A, B]
 *
 * @author Matt T
 *
 */

public class ListItrTest_22_AB_add0C_CAB
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_22_AB_add0C_CAB"; 
	...
	public void initialize()
	{
		...
		// apply change
		list.add(0, ListIteratorTests.C);
