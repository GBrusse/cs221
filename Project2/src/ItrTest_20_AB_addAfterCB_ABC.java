 ...
 * Iterator Tests for Change Scenario 20: [A, B] -> addAfter(C, B) -> [A, B, C]
 *
 * @author Matt T
 *
 */	
public class ItrTest_20_AB_addAfterCB_ABC
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_20_AB_addAfterCB_ABC"; 
	...
	public void initialize()
	{
		...
		// apply change
		list.addAfter(IteratorTests.C, IteratorTests.B);
