 ...
 * Iterator Tests for Change Scenario 36: [A, B, C] -> remove(B) -> [A, C]
 *
 * @author Matt T
 *
 */
public class ItrTest_36_ABC_removeB_AC
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_36_ABC_removeB_AC"; 
