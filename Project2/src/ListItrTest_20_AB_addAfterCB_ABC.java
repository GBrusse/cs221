 ...
 * ListIterator Tests for Change Scenario 20: [A, B] -> addAfter(C, B) -> [A, B, C]
 *
 * @author Matt T
 *
 */

public class ListItrTest_20_AB_addAfterCB_ABC
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_20_AB_addAfterCB_ABC"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 20: [A, B] -> addAfter(C, B) -> [A, B, C]"; 
	// Number of tests run 
	...
	private static final Character MIDDLE = ListIteratorTests.B; 
	...
	public void initialize()
	{
		...
		// apply change
		list.addAfter(ListIteratorTests.C, IteratorTests.B);
