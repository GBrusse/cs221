 ...
 * ListIterator Tests for Change Scenario 16: [A] -> set(0, B) -> [B]
 *
 * @author Matt T
 *
 */

public class ListItrTest_16_A_set0B_B
{
	...
	// Name of class
	private static String CLASS_NAME = "ListItrTest_16_A_set0B_B"; 
	// Description of change scenario testing 
	private static final String testDescription = 
			"Change Scenario 16: [A] -> set(0, B) -> [B]"; 
	// Number of tests run 
	...
	// Element in list 
	private static final Character VALID_ELEMENT = ListIteratorTests.B; 
	...
	public void initialize()
	{
		...
		// apply change
		list.set(0, ListIteratorTests.B);
