 ...
 * Iterator Tests for Change Scenario 18: [A, B] -> addToRear(C) -> [A, B, C]
 *
 * @author Matt T
 *
 */	
public class ItrTest_18_AB_addToRearC_ABC
{
	...
	// Name of class
	private static String CLASS_NAME = "ItrTest_18_AB_addToRearC_ABC"; 
	...
	public void initialize()
	{
		...
		// apply change
		list.addToRear(IteratorTests.C); 
